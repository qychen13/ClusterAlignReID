# a lot copy from https://github.com/seathiefwang/MGN-pytorch
import copy
import torch
...
class MGN(nn.Module):
    def __init__(self, num_classes):
        ...
        pretrain_dict = torch.load('../modelzoo/resnet50-19c8e357.pth')
    ...
    def forward(self, x):
        ...
        predict = torch.stack([f0_p3, f1_p3, f2_p3], dim=2)
        predict_test = torch.cat([fg_p1, fg_p2, fg_p3, f0_p2, f1_p2, f0_p3, f1_p3, f2_p3], dim=1)

        return dict(features_test=predict_test, features=predict, logits=[l_p1, l_p2, l_p3, l0_p2, l1_p2, l0_p3, l1_p3, l2_p3])
