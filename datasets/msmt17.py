...
class MSMT17(BaseImageDataset):
    ...
    def __init__(self, root, verbose=True, **kwargs):
        ...
        self.list_train_path = osp.join(
            self.dataset_dir, 'MSMT17_V2/list_train.txt')
        self.list_val_path = osp.join(
            self.dataset_dir, 'MSMT17_V2/list_val.txt')
        self.list_query_path = osp.join(
            self.dataset_dir, 'MSMT17_V2/list_query.txt')
    ...
    def _process_dir(self, dir_path, list_path):
        ...
        for img_idx, img_info in enumerate(lines):
            ...
            dataset.append((img_path, dict(pid=pid, camid=camid)))
