...
class BaseVideoDataset(BaseDataset):
    ...
    def print_dataset_statistics(self, train, query, gallery):
        ...
        tracklet_stats = train_tracklet_stats + \
            query_tracklet_stats + gallery_tracklet_stats
